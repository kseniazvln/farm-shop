...
class _$_ProductDetail implements _ProductDetail {
  ...
  @override
  String toString() {
    return 'ProductDetail(id: $id, price: $price, name: $name, count: $count, brand: $brand, picture: $picture, article: $article, description: $description, available: $available, rating: $rating, oldPrice: $oldPrice, reviewsCount: $reviewsCount)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, price, name, count, brand,
      picture, article, description, available, rating, oldPrice, reviewsCount);
